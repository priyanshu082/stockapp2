  ...
  return (
    <>
      ...
      <div className="left sm:w-[40%] w-[100%] sm:h-[100%] h-[30%] px-5 sm:px-0 sm:pl-20 flex items-center">
        <h1 className=' text-[6vw] sm:max-md:text-3xl sm:text-[5vw] md:text-5xl  text-center font-medium text-[#3B55B2]' data-aos="fade-up"   data-aos-delay="300">Your Journey To Financial Success Begins Here</h1>
      </div>
