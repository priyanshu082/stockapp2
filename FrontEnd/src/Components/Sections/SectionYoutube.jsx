...
const SectionYoutube = () => {
  return (
   ...
   <div className="top  h-[40%] sm:h-[30%] w-full px-10 sm:px-0 sm:pl-20 sm:pt-10">
    <h1 className=" text-xl sm:text-3xl text-[#0328AC]" data-aos="fade-down"   > Trusted by more than <span className="text-red-700"> 1.5 Million </span> Subscribers and Counting</h1>
