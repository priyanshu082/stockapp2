...
const Footer = () => {
  return (
    <>
      <div className=' w-full h-[100vh] sm:max-md:h-[80vh] bg-white'>
      ...
      <div className='flex flex-col sm:flex-row gap-10 sm:gap-20 sm:max-md:gap-10 text-sm'>
